...
import { denyPreToolUse, pass, warnPreToolUse } from "./lib/hook-response.ts";
...
import {
  ...
  isWriteTool,
  pathMatchesAny,
} from "./lib/tool-classifier.ts";
import { flattenText, includesAny, normalizePath } from "./lib/text-patterns.ts";
