...
import { allowPermissionRequest, denyPermissionRequest } from "./lib/hook-response.js";
import { loadSafetyPolicy } from "./lib/policy-loader.js";
import { commandMatchesAny, getDestructiveCommandPatterns } from "./lib/tool-classifier.js";
import { flattenText, includesAny } from "./lib/text-patterns.js";
import type { StringList } from "./lib/types.js";
...
function isHighRiskRequest(commandText: unknown, fullText: string, destructiveCommandPatterns: StringList): boolean {
