...
const allowedValidation = runHook("permission_request_policy.mjs", {
  hookEventName: "PermissionRequest",
  command: "npm run validate",
});
assert.equal(allowedValidation.hookSpecificOutput.decision.behavior, "allow");

const deniedDestroy = runHook("permission_request_policy.mjs", {
  hookEventName: "PermissionRequest",
...
const deniedDockerPrune = runHook("permission_request_policy.mjs", {
  hookEventName: "PermissionRequest",
...
const allowedWithRecord = runHook("permission_request_policy.mjs", {
  hookEventName: "PermissionRequest",
  command: "terraform destroy",
  description:
