...
import { denyPreToolUse, pass, warnPreToolUse } from "./lib/hook-response.js";
import { loadSafetyPolicy } from "./lib/policy-loader.js";
import {
  commandMatchesAny,
  getCommandText,
  getDestructiveCommandPatterns,
  getToolName,
  getWriteTargets,
  isBashTool,
  isWriteTool,
  pathMatchesAny,
} from "./lib/tool-classifier.js";
import { flattenText, includesAny, normalizePath } from "./lib/text-patterns.js";
...
function hasPolicyOrHookTaskContext(value: HookInput): boolean {
